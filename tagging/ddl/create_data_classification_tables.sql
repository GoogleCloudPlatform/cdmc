create or replace table data_classification.infotype_selection(field_infotypes array<string>, notable_infotype STRING);

insert into data_classification.infotype_selection(field_infotypes, notable_infotype) 
...
create or replace table data_classification.infotype_classification(notable_infotypes array<string>, classification_result string, sensitivity_rank integer);

insert into data_classification.infotype_classification(notable_infotypes, classification_result, sensitivity_rank) 
